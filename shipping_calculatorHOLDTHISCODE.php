...
<form name="shipping" id="shipping" method="post" action="estimate.php">
 ...
 <div id="s_c_title">International Shipping Calculator COMING November 2017</div>
...
if($query!='')
{
	...
	{																										
	?>
	<option value="<?PHP echo($result['iso']); ?>"><?PHP echo($result['name']); ?></option>		
	<?php
		}
	}
?>
 ...
 <div class="s_c_inner_texture_holder"><input name="address" id="address" type="text" class="s_c_texture" /></div>
 </div>
