...
<form name="shipping" id="shipping" method="post" action="estimate.php">
 ...
 <div id="s_c_title">International Shipping Calculator COMING OCTOBER 2017</div>
 ...
 <div class="s_c_inner_title" style="width:98.5%; padding-left:1.5%;">Shipping Destination</div>
 <div class="s_c_inner_content_frame">
 <div class="s_c_inner_texture_title">SHIPPING ADDRESS INCLUDING ZIP CODE</div>
 <div class="s_c_inner_texture_holder"><input name="address" id="address" type="text" class="s_c_texture" style="width:99.5%;" /></div>
 </div>
 ...
 <option value="1">Flat Rate Envelope &nbsp;&nbsp; 12.5 x 9.5 inches</option>
 <option value="1">Legal Flat Rate Envelope &nbsp;&nbsp; 15 x 9.5 inches</option>
 <option value="1">Padded Flat Rate Envelope &nbsp;&nbsp; 12.5 x 9.5 inches</option>
 <option value="1">Gift Card Envelope &nbsp;&nbsp; 10 x 7 inches</option>
 <option value="1">Small Flat Box &nbsp;&nbsp; 8 x 5 x 1 inches</option>
 <option value="1">Medium Flat Box &nbsp;&nbsp; 13 x 11 x 3 inches</option>
 <option value="1">Large Flat Box &nbsp;&nbsp; 23 x 11 x 3 inches</option>
 </select ></div>
 </div>
...
<div class="s_c_inner_right"  style="height:270px; margin-top:32px; xbackground-color:#F90;">
   <div class="s_c_inner_title">Your Preferred Courier</div>
 <div class="s_c_inner_content_frame">
 <div class="s_c_inner_texture_title">SELECT FROM THE DROP DOWN LIST</div>
 ...
 <option value="1">TNT Economy</option>
 <option value="1">TNT Express</option>
...
<div class="s_c_inner_texture_holder"> <div class="s_c_button" onclick="javascript:forwardvalues();">CALCULATE</div> </div>
</div>
</div> 
 </div>
 </div> 
