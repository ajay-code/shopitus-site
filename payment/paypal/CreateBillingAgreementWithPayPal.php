...
if ($createdPlan) {
    ...
    if (empty($startTime)) {
        ...
        $startTime = $time->toIso8601ZuluString();
    }
    ...
    // echo "Created Billing Agreement. Please visit the URL to Approve. <a href='{$approvalUrl}' >{$approvalUrl}</a>";
    include "agreement-url.php";
    return $agreement;
}
