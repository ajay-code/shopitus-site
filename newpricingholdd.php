...
<div ><img src="images/online_shopping.jpg" class="img-responsive">
  ...
  <ul class="price">
    ...
    <li>Your USA Address<i data-toggle="tooltip" data-placement="right" title="Up to 3 free photos on each package" class="fa fa-question-circle-o" aria-hidden="true"></i></li>
    <li>ShopitUs Shipping<i data-toggle="tooltip" data-placement="right" title="Up to 3 free photos on each package" class="fa fa-question-circle-o" aria-hidden="true"></i></li>
    <li>Real Time Shipment<i data-toggle="tooltip" data-placement="right" title="Up to 3 free photos on each package" class="fa fa-question-circle-o" aria-hidden="true"></i></li>
    <li>Free Package Storage<i data-toggle="tooltip" data-placement="right" title="Up to 3 free photos on each package" class="fa fa-question-circle-o" aria-hidden="true"></i></li>
    <li>Package Consolidation<i data-toggle="tooltip" data-placement="right" title="Up to 3 free photos on each package" class="fa fa-question-circle-o" aria-hidden="true"></i></li>
    <li class="grey"><strong>Monthly Fee</strong></li>
    <li class="grey"><a href="pricing.php" style="background-color:blue"  class="button">Compare Plans</a></li>
