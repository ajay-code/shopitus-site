...
<div class="member_buttons" style="background-color:#14A6FA; color:#fff;" >PACKAGES EXPECTED</div>
...
if($status == "active"){
          ...
          <div id="packages_expected_top"><div class="packages_expected_titles" style="margin-left:90px;">TRACKING NO.</div><div class="packages_expected_titles" style="margin-left:200px;">DATE ADDED</div></div>
