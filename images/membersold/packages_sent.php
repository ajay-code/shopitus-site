...
<a href="packages_received.php"><div class="member_buttons" id="mbtn4" onmouseover="javascript:changecolor4();" onmouseout="javascript:backtomain4();">PACKAGES RECEIVED</div></a>
<div class="member_buttons" style="background-color:#14A6FA; color:#fff;" >PACKAGES SENT</div>
...
if($status == "active"){
 ...
 ?>
          ...
          <div id="packages_expected_top"><div class="packages_expected_titles" style="margin-left:120px;">TRACKING NO.</div><div class="packages_expected_titles" style="margin-left:215px;">DATE DELIVERED</div></div>
	...
	?>      
          ...
          <div class="packages_expected_row">
          <div class="packages_expected_row_left"><?php echo $j+1; ?></div>
          <div class="packages_expected_row_mid" style="width:410px;"><?php echo $tracking[$j]; ?></div>
          <div class="packages_expected_row_right" ><?php echo  $delivery_date; ?></div>
          </div>
