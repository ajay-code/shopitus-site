...
document.getElementById("mbtn1").style.color = "#fff"; // forecolor
...
document.getElementById("mbtn2").style.borderBottomColor = "#14A6FA";
...
<div class="member_panel_left_inner" style="xbackground-color:#F90;">
...
<a href="index.php"><div class="member_buttons" id="mbtn1" onmouseover="javascript:changecolor1();" onmouseout="javascript:backtomain1();" style="border-bottom-color:#06c;"  >ADD NEW PACKAGE</div></a>
<div class="member_buttons" id="mbtn2"  style="background-color:#06c; border-bottom-color:#06c; color:#fff;">PACKAGES EXPECTED</div>
...
if ($status == "active") {
    ...
    if ($total == '') {
        ...
        echo "<input  type='text' style='background-color:#ECECEC; border:0px;' value='NO TRACKING CODES ADDED SO FAR.' class='p_e_texture' readonly/>";
        echo "</div>";
    } else {
        ?>
  ...
  <div id="packages_expected_data_frame_bottom_separator"></div>
    ...
    echo "<div id='packages_expected_msg_frame' >";
    echo "<input  type='text'  style='background-color:#ECECEC; border:0px;' value='PLEASE RENEW YOUR SUBSCRIPTION.' class='p_e_texture'  readonly />";
    echo "</div>";
}
