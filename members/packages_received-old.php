...
<a href="packages_expected.php"><div class="member_buttons" id="mbtn2"  onmouseover="javascript:changecolor2();" onmouseout="javascript:backtomain2();" style="border-bottom-color:#06c;">PACKAGES EXPECTED</div></a>
<div class="member_buttons" id="mbtn3" style="background-color:#06c; border-bottom-color:#06c; color:#fff;">PACKAGES RECEIVED</div>
...
if($status == "active"){
		  ...
		  $total = mysql_num_rows($results1);
 		  if($total >6){$changestyle = "class = 'max_rows'";}else{$changestyle = '';}
