...
document.getElementById("mbtn5").style.backgroundColor = "#06c"; // backcolor
document.getElementById("mbtn4").style.borderBottomColor = "#06c";
document.getElementById("mbtn5").style.borderBottomColor = "#06c";
}
...
document.getElementById("mbtn3").style.borderBottomColor = "#ccc";
document.getElementById("mbtn4").style.borderBottomColor = "#ccc";
}
...
<div class="drawer"  >
<div id ="nav" >
<div class="navigator_buttons_2" ><a href="../howwework.php" class="link_color">How It Works</a><div id="menu_holder_2"><a href="../how_it_works.php" class="menu  menu2">  X</a></div>
</div>
...
<div class="member_panel_left_inner">
...
<div class="member_panel_left_inner" style="height:146px; margin-top:2px; " >
        ...
        <?php
			if($status == ''){
		?>
           <a href = "../pricing1.php"><div class="member_panel_left_inner_title_link"><u>Purchase a Subscription Plan</u></div></a>
        <?php
			} else {
		?>
        		<div id="subs_separator"></div>
        		<div class="member_panel_left_inner_title" >Plan : Basic</div>
...
<div class="member_buttons" id="mbtn1" style="background-color:#06c; border-bottom-color:#06c; color:#fff;" >ADD NEW PACKAGE</div>
...
<a href="edit_account.php"><div class="member_buttons_2" id="mbtn5" onmouseover="javascript:changecolor5();" onmouseout="javascript:backtomain5();">ACCOUNT</div></a>
</div>
...
<div id="member_panel_detail_inner" >
...
<div class="member_panel_data_frame" style="  xbackground-color:#fC6;">
<input name="tracking" id="tracking" type="text" class="add_new_long_text_1" style="xwidth:310px;"  />
<select name="country" id="country" class="add_new_selectbox_1" >
...
<div class="add_new_titles_checkbox_1" style="xmargin-left:62px;"><input name="getname" id="getname"  type="checkbox" value="" onclick="javascript:getmyname('getname', 'shippingname');" class="add_new_checkbox_1" /></div>
<div class="add_new_titles_1">Add My Name</div>
</div>

<div class="member_panel_data_frame">
<input   name="shippingname" id="shippingname" type="text" class="add_new_long_text_2" />
</div>
...
<div class="add_new_titles_checkbox_2" style="xmargin-left:40px;"><input name="getadrs" id="getadrs" onchange="javascript:getmyaddress('getadrs', 'shippingadrs');" type="checkbox" value="" class="add_new_checkbox_2" /></div>
<div class="add_new_titles_2">Add My Address</div>
</div>

<div class="member_panel_data_frame">
<input name="shippingadrs" id="shippingadrs" type="text" class="add_new_long_text_3"  />
</div>
...
<div class="member_panel_data_frame">
<select name="destination" id="destination" class="add_new_selectbox_2" >
<option value="0">Select Your Destination ...</option>
<option value="australia">Australia</option>
<option value="newzeland">NewZeland</option>
</select>
<div id="value_box">
<input name="" type="text" class="add_new_long_text_4" value="US$" style="width:26px; border:0px solid;" readonly="readonly"/>
<input name="packagevalue" id="packagevalue" type="text" class="add_new_long_text_5"   onkeypress="return validateFloatKeyPress(this,event);"  style="width:62px; height:30px; padding:0px; border:0px solid;" />
</div>
<select name="courier" id="courier" class="add_new_selectbox_3"  >
...
<div id="add_new_msg_frame">
<div id="add_new_msg_frame_inner"><input name="addnew_msg" id="addnew_msg" type="text"   class="member_panel_msg_text" readonly="readonly" /></div>
<div class="add_new_btn_frame_1" onclick="javascript:save_tracking_no();">NEXT</div>
</div>
